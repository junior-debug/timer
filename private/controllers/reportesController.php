		...
		if (isset($_GET['mode'])) {
			...
			switch ($_GET['mode']) {
				...
				case 'consulta_auxiliar':
					...
					$a  = 	$_POST['fecha_d'];
					$b  = 	$_POST['fecha_h'];
					$campaign = $_SESSION['id_servicio'];
					$cargoUSer = $_SESSION['cargo'];
					$listSupervisor = $conexion->listSupervisor();
					$consultar = $conexion->consultarxauxiliar($a, $b, $campaign, $cargoUSer);
				...
				case 'descargaReporteConsulta_auxiliar':
					...
					$listSupervisor = $conexion->listSupervisor();
					$consultar = $conexion->consultarxauxiliarAlt($a, $b);
					echo '
				...
				case 'busquedaAgente':
					...
					$campaign = $_SESSION['id_servicio'];
					$cargoUSer = $_SESSION['cargo'];
					$consultar = $conexion->busquedaAgnte($texto, $campaign, $cargoUSer);
