...
<head>
  ...
  <title>SIMPLETV - FORMULARIO</title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <img src="public/images/logo_prc.png">
                    <h1 class="h4 text-gray-900 mt-3 mb-4">Bienvenido!</h1>
                  </div>
                  <div class="user">
                    <div class="form-group">
                      <input onkeyup="mayus(this);" type="text" class="form-control form-control-user" id="username" aria-describedby="username" placeholder="Introduce tu usuario..." maxlength="20">
                    ...
                    <input id="btn-login" type="submit" class="btn btn-primary btn-user btn-block" value="Ingresar" />
                  </div>
                </div>
              </div>
            </div>
