$(document).ready(function () {
      ...
      success: function (datos) {
        if (datos.response == "true") {
          ...
          if (datos.response2 == "true") {
            ...
            $("#tablaCasos").html(
              '<div class="form-group"><h5>No posee casos por inconvenientes con recargas.</h5></div>'
            );
          }
        } else {
          alert(
            "Cliente nos contacta por primera vez. Recuerda registrar sus datos."
          );
        }
        $("#formulario").show();
      },
  ...
  $("#tipoContacto").change(function () {
    ...
    if (
      $("#tipoContacto").val() == "CHAT" ||
      $("#tipoContacto").val() == "CORREO" ||
      $("#tipoContacto").val() == "RRSS"
    ) {
      $("#d_categoria1").show();
      $("#d_categoria2").show();
      $("#d_efectivo").hide();
      ...
      //EL TIPO DE CONTACTO ES LLAMADA
      $("#d_categoria1").hide();
      $("#d_categoria2").hide();
      $("#d_categoria3").hide();
      $("#d_noefectivo").hide();
      ...
      $("#tipoEfectivo").change(function () {
        if ($("#tipoEfectivo").val() == "SI") {
          //CONTACTO EFECTIVO SI
          $("#d_categoria1").show();
          $("#d_categoria2").show();
          $("#d_noefectivo").hide();
          $("#d_cliente_efectivo").hide();
      ...
      success: function (datos) {
        if (datos.response == "true") {
          ...
          for (var i = 0; i < res.length - 1; i++) {
            ...
            $("#categoria2").append(
              '<option value="' + res_1[0] + '">' + res_1[1] + "</option>"
            );
          }
        } else {
          var a = 1;
    ...
    if (
      ...
      $.ajax({
        ...
        data: {
          ...
          apellido_: apellido_,
          sexo_: sexo_,
          fecha_nacim_: fecha_nacim_,
          type_doc_: type_doc_,
          num_doc_: num_doc_,
          tlf_fijo_: tlf_fijo_,
          num_fijo_: num_fijo_,
          celular_: celular_,
          num_celular_: num_celular_,
          redsocial1_: redsocial1_,
          redsocial2_: redsocial2_,
          email_: email_,
          clave_: clave_,
          estado_: estado_,
          ciudad_: ciudad_,
          ...
          sector_: sector_,
          direccion1_: direccion1_,
          direccion2_: direccion2_,
